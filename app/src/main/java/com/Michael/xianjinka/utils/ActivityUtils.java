...
public final class ActivityUtils {
    ...
    public static boolean isActivityExists(@NonNull final String pkg,
        ...
        return !(App.getApp().getPackageManager().resolveActivity(intent, 0) == null ||
                intent.resolveActivity(App.getApp().getPackageManager()) == null ||
                App.getApp().getPackageManager().queryIntentActivities(intent, 0).size() == 0);
    }
    ...
    public static String getLauncherActivity() {
        return getLauncherActivity(App.getApp().getPackageName());
    }
    ...
    public static Drawable getActivityIcon(final Class<?> clz) {
        return getActivityIcon(new ComponentName(App.getApp(), clz));
    }
    ...
    private static Context getActivityOrApp() {
        ...
        return topActivity == null ? App.getApp() : topActivity;
    }
