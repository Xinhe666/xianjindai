...
import com.Michael.xianjinka.glide.GlideCircleTransform;
import com.Michael.xianjinka.inter.OnRequestDataListener;
import com.Michael.xianjinka.model.CreditBean;
import com.Michael.xianjinka.model.Product;
import com.Michael.xianjinka.model.ProductDetail;
        ...
        switch (view.getId()) {
            ...
            case R.id.apply:
                ...
                if(!TextUtils.isEmpty(token)){
                    new BrowsingHistory().execute(productDetail.getId());
