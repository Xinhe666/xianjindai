...
public final class AppUtils {
    ...
    public static String getAppName() {
        return getAppName(App.getApp().getPackageName());
    }
    ...
    public static Drawable getAppIcon() {
        return getAppIcon(App.getApp().getPackageName());
    }
    ...
    public static String getAppPath() {
        return getAppPath(App.getApp().getPackageName());
    }
    ...
    public static String getAppVersionName() {
        return getAppVersionName(App.getApp().getPackageName());
    }
    ...
    public static int getAppVersionCode() {
        return getAppVersionCode(App.getApp().getPackageName());
    }
    ...
    public static boolean isAppDebug() {
        return isAppDebug(App.getApp().getPackageName());
    }
    ...
    public static boolean isAppForeground() {
        ActivityManager manager =
                (ActivityManager) App.getApp().getSystemService(Context.ACTIVITY_SERVICE);
        ...
        for (ActivityManager.RunningAppProcessInfo aInfo : info) {
            if (aInfo.importance == ActivityManager.RunningAppProcessInfo.IMPORTANCE_FOREGROUND) {
                return aInfo.processName.equals(App.getApp().getPackageName());
            }
        }
        return false;
    }
    ...
    public static AppInfo getAppInfo() {
        return getAppInfo(App.getApp().getPackageName());
    }
